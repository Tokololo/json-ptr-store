...
exports.sortAny = void 0;
// @attribution https://github.com/oprogramador/sort-any
...
const typesValues = (0, lodash_1.values)(types);
const orderedTypes = (0, lodash_1.zipObject)(typesValues, Object.keys(typesValues).map(key => Number(key)));
const comparators = {
...
function compareArray(first, second) {
    ...
    const sortedFirst = (0, exports.sortAny)(first);
    const sortedSecond = (0, exports.sortAny)(second);
...
function compareObject(first, second) {
    ...
    const sortedFirstKeys = (0, exports.sortAny)(firstKeys);
    const sortedSecondKeys = (0, exports.sortAny)(secondKeys);
